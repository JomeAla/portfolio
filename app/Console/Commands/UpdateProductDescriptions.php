...
class UpdateProductDescriptions extends Command
{
    ...
    protected $description = 'Update all product full_description fields with compelling content';
...
<p class="text-orange-800 font-medium"><i class="fas fa-store mr-2"></i>Perfect for restaurants, salons, shops, service businesses.</p>
        ...
        $this->info(PHP_EOL . 'Done! All product descriptions have been updated.');
    }
}