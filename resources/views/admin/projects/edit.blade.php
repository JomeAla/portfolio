...
<form method="POST" action="/admin/projects/{{ $project->slug }}" enctype="multipart/form-data" class="space-y-6">
    @csrf
    @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="category" required class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none">
                    ...
                    <option value="wordpress" {{ $project->category == 'wordpress' ? 'selected' : '' }}>WordPress</option>
                    <option value="shopify" {{ $project->category == 'shopify' ? 'selected' : '' }}>Shopify</option>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200/50">
        ...
        <div class="mb-4">
            <img src="{{ asset($project->thumbnail) }}" alt="Thumbnail" class="w-48 h-32 object-cover rounded-lg">
