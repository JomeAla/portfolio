...
<div class="flex justify-between items-center mb-8">
    ...
    <a href="{{ route('admin.projects.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-xl transition-colors flex items-center gap-2">
            ...
            <tr class="hover:bg-gray-50">
                <td class="px-6 py-4">
                    <div class="flex items-center gap-4">
                        ...
                        <img src="{{ asset('storage/' . $project->thumbnail) }}" class="w-12 h-12 rounded-lg object-cover">
                        @else
                ...
                <td class="px-6 py-4">
                    <div class="flex items-center gap-3">
                        <a href="{{ route('admin.projects.edit', $project) }}" class="text-gray-400 hover:text-blue-600">
