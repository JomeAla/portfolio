...
@section('title', 'Login - My Account')
...
<div class="min-h-screen flex">
    ...
    <div class="flex-1 flex items-center justify-center p-8">
        <div class="w-full max-w-md">
            ...
            <form method="POST" action="/customer/login" class="space-y-5">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <input type="password" name="password" required class="w-full px-4 py-3.5 rounded-xl border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" placeholder="••••••••">
                </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-slate-600">Don't have an account? <a href="/customer/register" class="text-blue-600 font-semibold hover:underline">Create one</a></p>
            </div>
        </div>
    </div>
    
    <!-- Right Side - Visual -->
    <div class="hidden lg:flex flex-1 bg-gradient-to-br from-blue-600 via-violet-600 to-purple-700 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div class="relative text-white text-center max-w-md">
            ...
            <h2 class="text-3xl font-bold mb-4">Your Account, Your Control</h2>
            <p class="text-white/80">Access all your orders, downloads, subscriptions, and referrals in one place. plus earn rewards through our affiliate program.</p>
        </div>
    </div>
</div>
@endsection