...
// ---------------------------------------------------------------------------
// Secure API Gateway admin (issuer dashboard)
// ---------------------------------------------------------------------------
Route::middleware(['admin'])->prefix('admin')->name('admin.secure-api.')->group(function () {
    Route::get('/secure-api/licenses', [\App\Http\Controllers\Admin\SecureApiAdminController::class, 'licenses'])->name('licenses');
    Route::post('/secure-api/licenses', [\App\Http\Controllers\Admin\SecureApiAdminController::class, 'createLicense'])->name('licenses.create');
    Route::post('/secure-api/licenses/{id}/action', [\App\Http\Controllers\Admin\SecureApiAdminController::class, 'licenseAction'])->name('licenses.action');
    Route::get('/secure-api/plans', [\App\Http\Controllers\Admin\SecureApiAdminController::class, 'plans'])->name('plans');
    Route::post('/secure-api/plans/{id}', [\App\Http\Controllers\Admin\SecureApiAdminController::class, 'updatePlan'])->name('plans.update');
    Route::get('/secure-api/agency', [\App\Http\Controllers\Admin\SecureApiAdminController::class, 'agency'])->name('agency');
    Route::post('/secure-api/agency', [\App\Http\Controllers\Admin\SecureApiAdminController::class, 'createAgency'])->name('agency.create');
    Route::post('/secure-api/agency/action', [\App\Http\Controllers\Admin\SecureApiAdminController::class, 'agencyAction'])->name('agency.action');
    Route::get('/secure-api/events', [\App\Http\Controllers\Admin\SecureApiAdminController::class, 'events'])->name('events');
});